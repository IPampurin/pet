## В данном репозитории собраны минипроекты для иллюстрации проделанных работ, а также просто интересные решения. <p align="right"><img src="img/GopherDoctor.png" alt="Гофер" width="200" height="200"></p> 
