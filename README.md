## В данном репозитории собраны минипроекты для иллюстрации проделанных работ, а также просто интересные решения.  <img src="img/GopherDoctor.png" alt="Гофер" width="400" height="400"> 
